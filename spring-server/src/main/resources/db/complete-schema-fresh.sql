...
-- =====================================================================
-- 2. PRODUCTS TABLE (Shop Inventory)
-- =====================================================================
...
-- =====================================================================
-- 3. CART ITEMS TABLE (Shopping Cart Management)
-- =====================================================================
...
-- =====================================================================
-- 4. ORDERS TABLE (Order Management with Payment & Delivery)
-- =====================================================================
CREATE TABLE orders (
  id BIGINT AUTO_INCREMENT PRIMARY KEY,
  user_id BIGINT NOT NULL,
  ...
  delivery_type ENUM('collect', 'deliver'),
...
-- =====================================================================
-- 5. ORDER ITEMS TABLE (Items within an Order)
-- =====================================================================
...
-- =====================================================================
-- 6. ORDER LOCATION HISTORY TABLE (Order Status Tracking)
-- =====================================================================
...
-- =====================================================================
-- 7. PAYMENTS TABLE (Stripe Payment Tracking)
-- =====================================================================
...
-- =====================================================================
-- 8. EMAIL VERIFICATIONS TABLE (Email Confirmation for Registration)
-- =====================================================================
...
-- =====================================================================
-- 9. PASSWORD RESETS TABLE (Password Recovery)
-- =====================================================================
...
-- =====================================================================
-- 10. ENQUIRIES TABLE (Contact Form Submissions)
-- =====================================================================
...
-- Trigger: Auto-create payment record when new order with pending payment
DELIMITER //
...
-- =====================================================================
-- STEP 4: CREATE VIEWS FOR PAYMENT & ORDER HISTORY
-- =====================================================================

-- View: Complete order with payment info (for payment history page)
...
-- View: Payment statistics for dashboard
...
-- VALUES ('Test Client', 'client@test.com', 'hashed_password', 'client', true);

-- Insert test admin
-- INSERT INTO users (name, email, password_hash, role, is_verified) 
-- VALUES ('Admin User', 'admin@test.com', 'hashed_password', 'admin', true);

-- Insert test product
-- INSERT INTO products (name, description, price, stock, is_active) 
-- VALUES ('Test Lock', 'High quality test lock', 299.99, 50, true);

-- =====================================================================
-- DATABASE SETUP COMPLETE
-- =====================================================================
-- All tables, triggers, and views have been created fresh
-- Run this script with: mysql -u root -p locksmith_db < complete-schema-fresh.sql
-- =====================================================================
